      ...
      <div className="w-full p-6 rounded-md shadow-md overflow-auto">
        ...
        <div className="relative overflow-x-auto bg-white shadow-customShadow rounded-md p-8 mb-2 text-black overflow-auto">
          ...
          <p className="text-[18px]">
            Dr. Hau (“we,” “our,” or “us”) is committed to protecting your
            privacy. This Privacy Policy explains how your personal information
            is collected, used, and disclosed by Dr. Hau.
          </p>
          <br />
          ...
          <p className="text-[18px]">
            ...
            Dr. Hau. By accessing or using our Service, you signify that you
          ...
          <ul className="text-[18px] list-disc pl-5">
            ...
            <li>
              ...
              “we,” “us,” or “our,” it refers to Benny Hau MD Inc, (700 W 7th
              Street G240, Los Angeles, CA 90017), that is responsible for your
            ...
            <li>
              ...
              person that signs up to use the Dr. Hau Service to manage the
            ...
            <li>
              ...
              and can often be used to identify the location from which a device
              is connecting to the Internet.
            </li>
            <li>
              <strong>Personnel:</strong> refers to those individuals who are
              employed by Dr. Hau or are under contract to perform a service on
          ...
          <p className="text-[18px]">
            Dr. Hau will collect End User Data necessary to provide the Dr. Hau
          ...
          <p className="text-[18px]">
            ...
            interest in becoming a Dr. Hau customer, we receive information from
            a third party that provides automated fraud detection services to
            Dr. Hau. We also occasionally collect information that is made
          ...
          <p className="text-[18px]">
            ...
            services you may purchase through the website/app. We will likely
          ...
          <p className="text-[18px]">
            ...
            visited the website/app in a shared location, and type of device
          ...
          <p className="text-[18px]">
            ...
            respond to claims, legal processes (including subpoenas), to protect
          ...
          <p className="text-[18px]">
            Dr. Hau will collect personal information that you submit to us. We
          ...
          <p className="text-[18px]">
            We keep your information only so long as we need it to provide Dr.
            Hau to you and fulfill the purposes described in this policy. This
          ...
          <p className="text-[18px]">
            ...
            information you transmit to Dr. Hau or guarantee that your
          ...
          <p className="text-[18px]">
            Dr. Hau is incorporated in the United States of America. Information
            collected via our website/app, through direct interactions with you,
          ...
          <p className="text-[18px]">
            ...
            information Dr. Hau collects depend on your relationship with Dr.
            Hau. Personnel may update or correct their information as detailed
          ...
          <p className="text-[18px]">
            ...
            deletion. To protect your privacy and security, we may take
          ...
          <h1 className="text-[24px] font-semibold pb-2">Personnel</h1>
          <p className="text-[18px]">
            If you are a Dr. Hau worker or applicant, we collect information you
          ...
          <h1 className="text-[24px] font-semibold pb-2">Sale of Business</h1>
          <p className="text-[18px]">
            ...
            all of the assets of Dr. Hau or any of its Corporate Affiliates (as
            defined herein), or that portion of Dr. Hau or any of its Corporate
          ...
          <h1 className="text-[24px] font-semibold pb-2">Affiliates</h1>
          <p className="text-[18px]">
            ...
            common control with Dr. Hau, whether by ownership or otherwise. Any
          ...
          <h1 className="text-[24px] font-semibold pb-2">Governing Law</h1>
          <p className="text-[18px]">
            This Privacy Policy is governed by the laws of the United States of
          ...
          <p className="text-[18px]">
            The laws of the United States of America, excluding its conflicts of
          ...
          <p className="text-[18px]">
            By using Dr. Hau or contacting us directly, you signify your
          ...
          <p className="text-[18px]">
            ...
            it's being used. By using our Dr. Hau, registering an account, or
          ...
          <p className="text-[18px]">
            ...
            contain links to other websites not operated or controlled by Dr.
            Hau. We are not responsible for the content, accuracy, or opinions
          ...
          <h1 className="text-[24px] font-semibold pb-2">Kids' Privacy</h1>
          <p className="text-[18px]">
          ...
          <ul className="text-[18px] list-disc pl-5">
            <li>
              <strong>Cookies:</strong> We use Cookies to enhance the
              performance and functionality of our platform but are
              ...
              the platform as we would not be able to remember that you had
              logged in previously.
            </li>
            <li>
              <strong>Local Storage:</strong> Local Storage, sometimes known as
              DOM storage, provides web apps with methods and protocols for
              storing client-side data. Web storage supports persistent data
              storage, similar to cookies but with a greatly enhanced capacity
              and no information stored in the HTTP request header.
            </li>
            <li>
              <strong>Sessions:</strong> We use "Sessions" to identify the areas
              of our platform that you have visited. A Session is a small piece
          ...
          <p className="text-[18px]">
            ...
            Policy, we are going to explain exactly how and why this data is
            collected, and how we maintain this data under protection from being
            replicated or used in the wrong way.
          </p>
          <h1 className="text-[24px] font-semibold pb-2">What is GDPR?</h1>
          <p className="text-[18px]">
            ...
            control EU residents have over their personal data.
          </p>
          <p className="text-[18px]">
          ...
          <ul className="text-[18px] list-disc pl-5">
            ...
            <li>
              Personal data should be held no longer than necessary to fulfill
              its purpose.
            </li>
            <li>
          ...
          <p className="text-[18px]">
            ...
            imposing greater fines for breaches. Beyond these facts, it's simply
            the right thing to do. At Dr. Hau, we strongly believe that your
          ...
          <p className="text-[18px]">
            ...
            rights requirements of GDPR. Dr. Hau processes or stores all
          ...
          <ul className="text-[18px] list-disc pl-5">
            ...
            <li>
              <strong>Request Not to Sell Personal Data:</strong> You may
          ...
          <ul className="text-[18px] list-disc pl-5">
            ...
            <li>
              <strong>Via this Address:</strong> 700 W 7th Street G240, Los
              Angeles, CA 90017
            </li>
          </ul>
        </div>
