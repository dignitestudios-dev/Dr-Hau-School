      ...
      <div className="w-full p-6 rounded-md shadow-md overflow-auto">
        ...
        <div className="relative overflow-x-auto bg-white shadow-customShadow rounded-md p-8 mb-2 text-black overflow-auto">
          ...
          <p className="text-[18px]">
            ...
            apply to transactions at Dr. Hau . Weâ€™ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at Dr. Hau , you agree to the terms
            along with Dr. Hau â€™s Privacy Policy.
          </p>
          <p className="text-[18px]">
          ...
          <h1 className="text-[24px] font-semibold pb-2">Your Suggestions</h1>
          <p className="text-[18px]">
            Any feedback, comments, ideas, improvements or suggestions
            (collectively, "Suggestions") provided by you to Dr. Hau with
          ...
          <p className="text-[18px]">
            Dr. Hau shall be free to use, copy, modify, publish, or redistribute
            the Suggestions for any purpose and in any way without any credit or
            any compensation to you.
          </p>

          <h1 className="text-[24px] font-semibold pb-2">Your Consent</h1>
          <p className="text-[18px]">
          ...
          <p className="text-[18px]">
            ...
            Dr. Hau. We are not responsible for the content, accuracy or
          ...
          <h1 className="text-[24px] font-semibold pb-2">Cookies</h1>
          <p className="text-[18px]">
            Dr. Hau uses "Cookies" to identify the areas of our website/app that
            ...
            access functionality on our website/app correctly or at all. We
          ...
          <p className="text-[18px]">
            You acknowledge and agree that Dr. Hau may stop (permanently or
            temporarily) providing the Service (or any features within the
            Service) to you or to users generally at Dr. Hau’s sole discretion,
            without prior notice to you. You may stop using the Service at any
            time. You do not need to specifically inform Dr. Hau when you stop
            using the Service. You acknowledge and agree that if Dr. Hau
          ...
          <p className="text-[18px]">
            Dr. Hau reserves the right to modify, suspend or discontinue,
          ...
          <p className="text-[18px]">
            Dr. Hau may from time to time provide enhancements or improvements
          ...
          <p className="text-[18px]">
            ...
            of the website/app. You agree that Dr. Hau has no obligation to (i)
          ...
          <p className="text-[18px]">
            You acknowledge and agree that Dr. Hau shall not be responsible for
            any Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. Dr. Hau does not assume and
          ...
          <p className="text-[18px]">
            This Agreement shall remain in effect until terminated by you or Dr.
            Hau.
          </p>
          <br />

          <p className="text-[18px]">
            Dr. Hau may, in its sole discretion, at any time and for any or no
          ...
          <p className="text-[18px]">
            ...
            Dr. Hau, in the event that you fail to comply with any provision of
          ...
          <p className="text-[18px]">
            Termination of this Agreement will not limit any of Dr. Hau's rights
          ...
          <p className="text-[18px]">
            ...
            owners; and (e) a statement that the information in the notification
            is accurate, and, under penalty of perjury, you are authorized to
            act on behalf of the owner.
          </p>
          <br />

          <h1 className="text-[24px] font-semibold pb-2">Indemnification</h1>
          <p className="text-[18px]">
            You agree to indemnify and hold Dr. Hau and its parents,
          ...
          <h1 className="text-[24px] font-semibold pb-2">No Warranties</h1>
          <p className="text-[18px]">
            ...
            maximum extent permitted under applicable law, Dr. Hau, on its own
            ...
            limitation to the foregoing, Dr. Hau provides no warranty or
          ...
          <p className="text-[18px]">
            Without limiting the foregoing, neither Dr. Hau nor any of Dr. Hau's
            ...
            or on behalf of Dr. Hau are free of viruses, scripts, trojan horses,
          ...
          <p className="text-[18px]">
            ...
            liability of Dr. Hau and any of its suppliers under any provision of
          ...
          <p className="text-[18px]">
            ...
            Dr. Hau or its suppliers be liable for any special, incidental,
            ...
            connection with any provision of this Agreement), even if Dr. Hau or
          ...
          <h1 className="text-[24px] font-semibold pb-2">Severability</h1>
          <p className="text-[18px]">
          ...
          <p className="text-[18px]">
            ...
            notices published by Dr. Hau on the Services, shall constitute the
            entire agreement between you and Dr. Hau concerning the Services. If
            ...
            such term or any other term, and Dr. Hau’s failure to assert any
            right or provision under this Agreement shall not constitute a
            waiver of such right or provision. YOU AND Dr. Hau AGREE THAT ANY
          ...
          <h1 className="text-[24px] font-semibold pb-2">Waiver</h1>
          <p className="text-[18px]">
          ...
          <p className="text-[18px]">
            Dr. Hau reserves the right, at its sole discretion, to modify or
          ...
          <h1 className="text-[24px] font-semibold pb-2">Entire Agreement</h1>
          <p className="text-[18px]">
            The Agreement constitutes the entire agreement between you and Dr.
            Hau regarding your use of the website/app and supersedes all prior
            and contemporaneous written or oral agreements between you and Dr.
            Hau.
          </p>
          <br />
          ...
          <p className="text-[18px]">
            ...
            when you use or purchase other Dr. Hau services, which Dr. Hau will
          ...
          <p className="text-[18px]">
            ...
            arrangement thereof), are owned by Dr. Hau, its licensors or other
            providers of such material and are protected by United States of
            ...
            prior written permission of Dr. Hau, unless and except as is
          ...
          <p className="text-[18px]">
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Dr. Hau’s
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and Dr. Hau concerning the
          ...
          <h1 className="text-[24px] font-semibold pb-2">Notice of Dispute</h1>
          <p className="text-[18px]">
            In the event of a dispute, you or Dr. Hau must give the other a
            ...
            send any Notice of Dispute via email to: drhau@sculptdtla.com. Dr.
            Hau will send any Notice of Dispute to you by mail to your address
            if we have it, or otherwise to your email address. You and Dr. Hau
            ...
            After sixty (60) days, you or Dr. Hau may commence arbitration.
          </p>
          <br />
          ...
          <p className="text-[18px]">
            If you and Dr. Hau don’t resolve any dispute by informal
          ...
          <p className="text-[18px]">
            ...
            property of Dr. Hau without any compensation or credit to you
            whatsoever. Dr. Hau and its affiliates shall have no obligations
          ...
          <h1 className="text-[24px] font-semibold pb-2">Promotions</h1>
          <p className="text-[18px]">
            Dr. Hau may, from time to time, include contests, promotions,
          ...
          <h1 className="text-[24px] font-semibold pb-2">Miscellaneous</h1>
          <p className="text-[18px]">
            ...
            signed by an authorized representative of Dr. Hau. Dr. Hau will be
            ...
            breach or anticipatory breach by you. Dr. Hau operates and controls
            the Dr. Hau Service from its offices in the United States of
            America. The Service is not intended for distribution to or use by
            any person or entity in any jurisdiction or country where such
            distribution or use would be contrary to law or regulation.
            Accordingly, those persons who choose to access the Dr. Hau Service
            ...
            and incorporate the Dr. Hau Privacy Policy) contain the entire
            understanding, and supersede all prior understandings, between you
            and Dr. Hau concerning its subject matter, and cannot be changed or
          ...
          <h1 className="text-[24px] font-semibold pb-2">Disclaimer</h1>
          <p className="text-[18px]">
            Dr. Hau is not responsible for any content, code or any other
            imprecision.
          </p>
          <br />
          ...
          <p className="text-[18px]">
            In no event shall Dr. Hau be liable for any special, direct,
          ...
          <p className="text-[18px]">
            The Dr. Hau Service and its contents are provided "as is" and "as
            available" without any warranty or representations of any kind,
            whether express or implied. Dr. Hau is a distributor and not a
            publisher of the content supplied by third parties; as such, Dr. Hau
            ...
            provided through or accessible via the Dr. Hau Service. Without
            limiting the foregoing, Dr. Hau specifically disclaims all
            warranties and representations in any content transmitted on or in
            connection with the Dr. Hau Service or on sites that may appear as
            links on the Dr. Hau Service, or in the products provided as a part
            of, or otherwise in connection with, the Dr. Hau Service, including
            without limitation any warranties of merchantability, fitness for a
            particular purpose or non-infringement of third party rights. No
            oral advice or written information given by Dr. Hau or any of its
            ...
            change without notice. Without limiting the foregoing, Dr. Hau does
            not warrant that the Dr. Hau Service will be uninterrupted,
            uncorrupted, timely, or error-free.
          </p>
          <br />

          <h1 className="text-[24px] font-semibold pb-2">Contact Us</h1>
          <p className="text-[18px]">
          ...
          <ul className="text-[18px] list-disc pl-5">
            <li>
              Via Email:{" "}
              <a href="mailto:drhau@sculptdtla.com">drhau@sculptdtla.com</a>
            </li>
            ...
            <li>
              Via this Address: 700 W 7th Street G240, Los Angeles, CA 90017
            </li>
          </ul>
        </div>
      </div>
